...
async def my_hobby(update, context):
    ...
    await update.message.reply_text(
        ...
        "Но айтишная страcть состоит в разработке *NLP*, и не только, инструментов для осетинского языка: мультимедийного учебника по фонетике и словарей в машиночитаемом виде для осетинского языка\.\n"
